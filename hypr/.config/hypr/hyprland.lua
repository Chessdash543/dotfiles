...
hl.on("hyprland.start", function () 
  hl.exec_cmd("hyprlock & awww-daemon & awww --restore & waybar & eww daemon & nm-applet & hypridle & /usr/lib/hyprpolkitagent/hyprpolkitagent")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(255,0,255,1.000)", "rgba(0, 175, 255, 1)"}, angle = 0 },
            inactive_border = { colors = {"rgba(23, 18, 29, 1)", "rgba(47, 49, 47, 1)"}, angle = 0 },
        },
...
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd(menu2))
